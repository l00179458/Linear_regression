...
#readRDS(model_1,"./model_2.rds")

# AIC and BIC
paste('AIC of First model', AIC(model))
paste('AIC of second model',AIC(model_1))

paste('BIC of First model',BIC(model))


##use format %f, %e, %g or %a for numeric objects

sprintf('BIC of second model %e', BIC(model_1))
